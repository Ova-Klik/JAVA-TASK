...
public class TransactionLogSystem {
    ...
    public static double withdraw(double accountBalance) {
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (more.equalsIgnoreCase("yes")) continue repeat;
                else if (more.equalsIgnoreCase("no")) {
                    System.out.printf("%nThank you!%n");
                    return accountBalance;
    ...
    public static void displayTransactionHistory(ArrayList<String[]> transactionHistory) {
        ...
        if (transactionHistory.isEmpty()) {
            ...
            System.out.printf("%-5s %-15s %-15s %-15s %-15s %s%n",
            ...
            for (String[] transaction : transactionHistory) {
                ...
                double balance = Double.parseDouble(transaction[4]);
                System.out.printf("%-5s %-15s %-15s %-15s $%,-15.2f $%,.2f%n%n",index,
                transaction[0], transaction[1], transaction[2], amount, balance);
                index++;
            }
        }
